...
{
    public class GetAllCouponHandler : IRequestHandler<GetAllCouponRequest, List<Coupon>>
    {
        private readonly ICouponRepository couponRepository;
        private readonly IMapper mapper;

        public GetAllCouponHandler(IMapper mapper, ICouponRepository couponRepository)
        {
